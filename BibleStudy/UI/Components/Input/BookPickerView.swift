        ...
        Button {
            ...
            .background(
                RoundedRectangle(cornerRadius: Theme.Radius.card)
                    .fill(Color("AppAccentAction"))
                    .shadow(
                        color: Color("AppAccentAction").opacity(Theme.Opacity.focusStroke),
                        radius: 8,
                        x: 0,
                        y: 4
                    )
    ...
    var body: some View {
        HStack(spacing: Theme.Spacing.sm) {
            Rectangle()
                .fill(
                    LinearGradient(
                        colors: [.clear, Color("AppAccentAction").opacity(Theme.Opacity.disabled)],
                        startPoint: .leading,
                        endPoint: .trailing
                    )
                )
            ...
            Rectangle()
                .fill(
                    LinearGradient(
                        colors: [Color("AppAccentAction").opacity(Theme.Opacity.disabled), .clear],
                        startPoint: .leading,
                        endPoint: .trailing
                    )
                )
        ...
        Button(action: action) {
            ZStack {
                ...
                Circle()
                    ...
                    .shadow(
                        color: isSelected ? Color("AppAccentAction").opacity(Theme.Opacity.overlay) : .clear,
                        radius: 6,
                        x: 0,
                        y: 2
                    )
                ...
                if !isSelected {
                    Circle()
                        .stroke(
                            isCurrent ? Color("AppAccentAction") : Color("AppDivider"),
    ...
    var body: some View {
        Button(action: action) {
            VStack(spacing: 2) {
                ...
                Text("\(book.chapters) ch")
                    .font(Typography.Command.meta.monospacedDigit())
                    .foregroundStyle(isSelected ? .white.opacity(Theme.Opacity.pressed) : Color("AppTextSecondary"))
            }
            .frame(maxWidth: .infinity)
            .padding(.vertical, Theme.Spacing.md)
            .background(
