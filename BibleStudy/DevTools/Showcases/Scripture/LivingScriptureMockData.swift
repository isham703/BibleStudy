...
enum LivingScriptureMood: String, CaseIterable {
    ...
    var moodColor: Color {
        ...
        case .redemption: return Color.accentBronze
    ...
    var gradientColors: [Color] {
        switch self {
        case .contemplative: return [Color(hex: "2C1810"), Color.surfaceDeep]
        case .excited: return [Color(hex: "2D1F1F"), Color.surfaceDeep]
        case .desolate: return [Color(hex: "0F1419"), Color.surfaceDeep]
        case .broken: return [Color(hex: "0A0A14"), Color(hex: "050508")]
        case .redemption: return [Color(hex: "1A1408"), Color.surfaceDeep]
        ...
        case .holy: return [Color(hex: "2A2618"), Color.surfaceDeep]
