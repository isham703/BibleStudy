...
struct ScholarsAtriumPage: View {
    ...
    // MARK: - Reader Showcase Section

    private var readerShowcaseSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            NavigationLink(destination: ReaderShowcaseDirectoryView()) {
                HStack(spacing: 0) {
                    // Vertical accent bar
                    Rectangle()
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        HStack(spacing: 6) {
                            ...
                            Text("READER THEMES")
                                .font(SanctuaryTypography.Scholar.marginLabel)
                                .tracking(2.5)
                                .foregroundStyle(Color.divineGold)
                        }

                        // Description
                        Text("Explore different reading experiences for your Bible study")
        ...
        .opacity(isVisible ? 1 : 0)
        .offset(y: isVisible ? 0 : 20)
        .animation(.spring(response: 0.4, dampingFraction: 1.0).delay(0.45), value: isVisible)
    }

    // MARK: - AI Chat Showcase Section

    private var aiChatShowcaseSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            NavigationLink(destination: AIChatDirectoryView()) {
                HStack(spacing: 0) {
                    // Vertical accent bar
                    Rectangle()
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        // Description
                        Text("Compare AI chat designs for Bible study conversations")
                            .font(SanctuaryTypography.Scholar.marginBody)
                            .foregroundStyle(Color.inkWell)
                            .lineSpacing(4)
                    }
        ...
        .opacity(isVisible ? 1 : 0)
        .offset(y: isVisible ? 0 : 20)
        .animation(.spring(response: 0.4, dampingFraction: 1.0).delay(0.5), value: isVisible)
    }
}
                ...
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    HStack(spacing: 6) {
                        ForEach(tags, id: \.self) { tag in
                            Text(tag)
                                .font(SanctuaryTypography.Scholar.chipText)
