...
struct CandlelitSanctuaryPage: View {
    ...
    private var headerSection: some View {
        HStack(alignment: .center) {
            ...
            Text("Good evening, \(user.userName ?? "friend")")
                .font(SanctuaryTypography.Candlelit.greeting)
    ...
    private var verseSection: some View {
        VStack(spacing: SanctuaryTheme.Spacing.xl) {
            ...
            // Verse text
            Text("\"\(verse.text)\"")
                .font(SanctuaryTypography.Candlelit.verse)
            ...
            Text("— \(verse.reference)")
                .font(SanctuaryTypography.Candlelit.reference)
                .tracking(4)
        ...
        NavigationLink(destination: destination()) {
            VStack(alignment: .leading, spacing: isPrimary ? 12 : 8) {
                ...
                HStack(spacing: 8) {
                    ...
                    Text(label)
                        .font(SanctuaryTypography.Candlelit.featureLabel)
                        .tracking(3)
                        .foregroundStyle(accentColor)
                }
                ...
                Text(title)
                    .font(isPrimary
                        ? SanctuaryTypography.Candlelit.featureTitle
                ...
                // Subtitle
                Text(subtitle)
                    .font(SanctuaryTypography.Candlelit.featureSubtitle)
                    .foregroundStyle(Color.moonMist)
                    .lineLimit(1)
            }
