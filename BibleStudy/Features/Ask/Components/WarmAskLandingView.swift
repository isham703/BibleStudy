        ...
        Button(action: onTap) {
            ...
            .background(
                Capsule()
                    ...
                    .overlay(
                        Capsule()
                            .strokeBorder(Color.appDivider, lineWidth: Theme.Stroke.hairline)
                    )
            )
    ...
    var body: some View {
        Ellipse()
            .fill(
                RadialGradient(
                    colors: [
                        Color("AppAccentAction").opacity(glowIntensity * 0.15),
                        Color("AppAccentAction").opacity(glowIntensity * 0.08),
                        Color.clear
                    ],
                    center: .center,
                    startRadius: 0,
