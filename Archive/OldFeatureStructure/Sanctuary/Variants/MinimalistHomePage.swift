...
struct MinimalistHomePage: View {
        ...
        GeometryReader { geometry in
            ScrollView {
                VStack(spacing: 0) {
                    ...
                    Spacer()
                        .frame(height: HomeShowcaseTheme.Spacing.huge)
                    ...
                    actionSection
                        .padding(.horizontal, HomeShowcaseTheme.Spacing.xl)
                        .padding(.bottom, HomeShowcaseTheme.Spacing.xxxl)
                }
    ...
    private var headerSection: some View {
        HStack(alignment: .top) {
            ...
            Text(user.userName ?? "Welcome")
                .font(HomeShowcaseTypography.Minimalist.greeting)
    ...
    private var verseSection: some View {
        VStack(spacing: HomeShowcaseTheme.Spacing.xxl) {
            ...
            Text("\"\(verse.text)\"")
                .font(HomeShowcaseTypography.Minimalist.verse)
