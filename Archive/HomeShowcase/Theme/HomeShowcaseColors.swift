...
extension Color {
    ...
    /// Vermillion - red accent
    static let vermillion = Color(hex: "C94A4A")

    /// Lapis Lazuli - blue accent
    static let lapisLazuli = Color(hex: "2A5C8F")

    /// Malachite - green accent
    static let malachite = Color(hex: "3A7D5A")

    /// Amethyst - purple accent
    static let amethyst = Color(hex: "6B4C8C")
    ...
    // MARK: - Celestial Cathedral Palette (Memory Palace Variant)

    /// Celestial Purple - primary accent (alias for thresholdPurple)
    static let celestialPurple = Color(hex: "8b5cf6")

    /// Celestial Deep - cosmic void background
    static let celestialDeep = Color(hex: "0a0a0f")

    /// Celestial Pink - nebula accent
    static let celestialPink = Color(hex: "ec4899")

    /// Celestial Cyan - cosmic accent
    static let celestialCyan = Color(hex: "06b6d4")

    /// Celestial Starlight - bright text (alias for starlight)
    static let celestialStarlight = Color(hex: "f8fafc")

    /// Celestial Nebula Purple - ambient gradient
    static let celestialNebulaPurple = Color(hex: "4c1d95")

    /// Celestial Aurora - aurora waves accent
    static let celestialAurora = Color(hex: "22d3ee")
...
extension Color {
    ...
    // MARK: - Celestial Cathedral Gradients

    /// Celestial sky gradient - cosmic void with nebula hints
    static var celestialSkyGradient: LinearGradient {
        LinearGradient(
            stops: [
                .init(color: celestialDeep, location: 0),
                .init(color: Color(hex: "0f0a1a"), location: 0.3),
                .init(color: Color(hex: "1a0a2e"), location: 0.6),
                .init(color: celestialDeep, location: 1)
            ],
            startPoint: .top,
            endPoint: .bottom
        )
    ...
    /// Celestial nebula gradient - mesh of cosmic colors
    static var celestialNebulaGradient: RadialGradient {
        RadialGradient(
            colors: [
                celestialPurple.opacity(0.3),
                celestialPink.opacity(0.2),
                celestialCyan.opacity(0.1),
                Color.clear
            ],
            center: .center,
            startRadius: 50,
    ...
    /// Celestial glow gradient - stellar pulse
    static var celestialGlowGradient: RadialGradient {
        RadialGradient(
            colors: [
                celestialPurple.opacity(0.5),
                celestialPink.opacity(0.2),
                Color.clear
            ],
            center: .center,
    ...
    /// Celestial aurora gradient - top edge waves
    static var celestialAuroraGradient: LinearGradient {
        LinearGradient(
            colors: [
                celestialAurora.opacity(0.4),
                celestialPurple.opacity(0.2),
                Color.clear
            ],
            startPoint: .top,
            endPoint: .center
