...
enum HomePageVariant: String, CaseIterable, Identifiable {
    ...
    case prayersShowcase = "Prayers Showcase"
    case livingScriptureShowcase = "Living Scripture"
    ...
    var subtitle: String {
        ...
        case .prayersShowcase:
            return "Three Design Explorations"
        case .livingScriptureShowcase:
            return "Immersive Narratives"
        }
    }
    ...
    var description: String {
        ...
        case .prayersShowcase:
            return "Compare three atmospheric variations for AI-crafted prayers. Medieval manuscript, desert stillness, and aurora glass."
        case .livingScriptureShowcase:
            return "Step inside biblical narratives as a first-person experience. Three visual styles: cinematic film, ancient scroll, and stained glass."
        }
    }
    ...
    func paletteColor(_ index: Int) -> Color {
        ...
        case .prayersShowcase:
            return [.divineGold, Color(hex: "333333"), Color(hex: "8B5CF6"), .roseIncense][index]
        case .livingScriptureShowcase:
            return [Color(hex: "D4AF37"), Color(hex: "8B7355"), Color(hex: "9B59B6"), Color(hex: "0A0908")][index]
        }
    }
