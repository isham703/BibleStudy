...
// MARK: - Sacred Manuscript View
// Medieval scriptorium at twilight with illuminated borders and drop caps

struct SacredManuscriptView: View {
    ...
    private let variant = PrayersShowcaseVariant.sacredManuscript
        ...
        ZStack {
            ...
            LinearGradient(
                colors: [
                    ...
                    Color.manuscriptVellum.opacity(0.95),
                    Color(hex: "E8DCC8")
                ],
                startPoint: .top,
                endPoint: .bottom
            ...
            Canvas { context, size in
                for _ in 0..<200 {
                    ...
                    context.fill(
                        Path(ellipseIn: rect),
                        with: .color(.manuscriptOxide.opacity(0.03))
                    )
                }
            }
            ...
            RadialGradient(
                colors: [
                    Color.clear,
                    Color.manuscriptUmber.opacity(0.15)
                ],
                center: .center,
                startRadius: 200,
                endRadius: 500
            ...
            RadialGradient(
                colors: [
                    Color.manuscriptCandlelight.opacity(0.3 + breathePhase * 0.1),
                    Color.clear
                ],
                center: .bottom,
                startRadius: 0,
        ...
        GeometryReader { geometry in
            ...
            ZStack {
                ...
                RoundedRectangle(cornerRadius: 8)
                    .stroke(
                        Color.manuscriptGold.opacity(0.2),
                        lineWidth: 4
                    )
                    .blur(radius: 4)
                ...
                RoundedRectangle(cornerRadius: 8)
                    ...
                    .stroke(
                        LinearGradient(
                            colors: [.manuscriptGold, .manuscriptOxide, .manuscriptGold],
    ...
    private var inputPhase: some View {
        VStack(spacing: 32) {
            ...
            ZStack {
                Circle()
                    .fill(Color.manuscriptGold.opacity(0.1))
            ...
            VStack(spacing: 12) {
                ...
                Text("Describe your situation, and I'll craft a prayer in the tradition of the ancients.")
                    ...
                    .foregroundStyle(Color.manuscriptOxide.opacity(0.8))
            ...
            Button(action: generatePrayer) {
                ...
                .foregroundStyle(Color.manuscriptCandlelight)
                .padding(.horizontal, 40)
                .padding(.vertical, 18)
                .background(
                    Capsule()
                        .fill(Color.manuscriptVermillion)
                )
                .overlay(
                    Capsule()
                        .stroke(Color.manuscriptGold.opacity(0.5), lineWidth: 1)
                )
                .shadow(color: Color.manuscriptVermillion.opacity(0.3), radius: 12, y: 4)
            }
        ...
        VStack(spacing: 32) {
            ...
            ZStack {
                ForEach(0..<3, id: \.self) { i in
                    Circle()
                        .stroke(Color.manuscriptGold.opacity(0.3 - Double(i) * 0.1), lineWidth: 2)
