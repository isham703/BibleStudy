...
struct NarrativeHomePage: View {
    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 0) {
                ...
                // Content
                VStack(spacing: HomeShowcaseTheme.Spacing.xxxl) {
                    // Today's Word
                    verseSection
                ...
                .padding(.top, HomeShowcaseTheme.Spacing.xxxl)
    ...
    private var heroSection: some View {
        ZStack {
            ...
            VStack(spacing: HomeShowcaseTheme.Spacing.lg) {
                ...
                Text(String(heroTitle.prefix(titleCharacterIndex)))
                    .font(HomeShowcaseTypography.Narrative.heroTitle)
                    .tracking(6)
                ...
                Text(HomeShowcaseMockData.fullGreeting)
                    .font(HomeShowcaseTypography.Narrative.heroGreeting)
                ...
                HStack(spacing: HomeShowcaseTheme.Spacing.lg) {
                    Text("Day \(plan.currentDay) of John")
                        .font(HomeShowcaseTypography.Narrative.heroStats)
                ...
                Button(action: {}) {
                    HStack(spacing: 8) {
                        Text("Continue Journey")
                            .font(HomeShowcaseTypography.Narrative.ctaButton)
        ...
        .frame(height: HomeShowcaseTheme.Size.heroHeight)
    }
